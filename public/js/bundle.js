...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3VyamVldGNzZSIsImEiOiJjazdvdHc0aG4wY2Z6M2ZvMm12NnhpdWkxIn0.avguSvfhYSvAjaNNUH65WQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/surjeetcse/ck7ou93fi0bqs1io2i65i7xyk',
    scrollZoom: false //   center: [-118.135854, 34.119489],
    //   zoom: 10,
    //   interective: false
...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, phoneNumber, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", (0, _alerts.showAlert)('error', 'Passwords do not match'));
          ...
          case 5:
            ...
            // console.log('res', res);
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your Account successfully Registered');
              window.setTimeout(function () {
...
var stripe = Stripe('pk_test_Gt8VWq5Ty87dWXB5XB5yy95F00sclCYHzk');
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(name, email, phoneNumber, password, passwordConfirm);
  });
}
